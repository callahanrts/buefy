    ...
    <div>
        ...
        <div class="media">
            ...
            <div class="media-content">
                ...
                <CodeView title="Full bundle" :code="$filters.pre(importingBundle)" lang="javascript" expanded/>
                <CodeView title="Individual components as Vue plugins" :code="$filters.pre(importingComponentsAsVuePlugins)" lang="javascript" expanded/>
        ...
        <div class="media">
            ...
            <div class="media-content">
                ...
                <CodeView :code="$filters.pre(importingCDNHtml)" expanded/>
            </div>
        </div>
        ...
        <div class="media">
            ...
            <div class="media-content">
                ...
                <CodeView :code="$filters.pre(importingNuxtBuefy)" lang="javascript" expanded/>
            </div>
        </div>
    </div>
</template>
